...
Lastly, Metacritic's average review across different platforms highlights a 
difference in scores based on the platform. This could suggest that game review
scores can be helped estimated based on the console the game was on. 
...
\(~ N(\mu_i, \sigma^2)\)  with \(\mu_i\ = \beta_0 + \beta_1X_{i1} + \beta_2X_{i2} 
+ \beta_3X_{i3} + \beta_4X_{i4} +\beta_5X_{i5}\)
