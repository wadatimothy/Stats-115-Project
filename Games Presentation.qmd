...
In our pursuit for coming up with informative priors for our analysis, We leveraged 3 different data sets and news reports/articles to formulate our expectations.
...
We used the Metacritic data set to formulate our prior by looking at both the metascore and userscore:
...
-   As an outlet for our prior, we leveraged several online articles. Of note, we found that the average sales of a video game were 277,500.

-   Without an explicit variance, we used a a heuristic to approximate a variance of 197,500

-   Thus, our chosen prior model: (N(277,500,197,500\^2))

# Rating & Game Length

Upon review of literature from external sources, we have chosen to go with vague priors for both of these features. This is due to information informing us that there may be no connection between average review scores and their rating or game length. Thus:
